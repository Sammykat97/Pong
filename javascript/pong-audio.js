...
export var wallSound = new soundFile("sqweek toy.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("boing.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("jum sound.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("pong background.mp3");
